...
export enum InteligenciaArtificialEnum {
  FerramentasIAGratis = "/inteligencia-artificial/ranking-2024-03-ferramentas-ia-gratis-mais-interessantes",
...
export function InteligenciaArtificialItems(
  ...
  const items: SecondarySidebarItem[] = [
    {
      title:
        "Lista com as Ferramentas de IA Grátis mais interessantes | Ranking 2024-03",
